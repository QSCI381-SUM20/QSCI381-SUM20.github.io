...
```{r load_chick_data, warning = F, message = F, eval = F}
...
1. **Construct a two-way table for type of college and degree length using the `table` command.** 
    ...
    f. **If you choose a school at random from the dataset, what is the probability of choosing a private, 4-year school?**
    
    YOUR ANSWER HERE
    
    g. **If you choose two schools at random (with replacement) from the dataset, what is the probability of choosing two private schools?**
    
    YOUR ANSWER HERE
    
    h. **Is there an association between type of college and degree length? Justify your answer.**
...
4. **Finally, let's practice Bayes' rule.** 
